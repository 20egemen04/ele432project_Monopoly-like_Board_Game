...
# Gemini corrected this
set_output_delay -max -clock [get_clocks {VGA_DISPLAY|vga_inst|pll_inst|vga_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] 0.220 [get_ports {VGA_R[*]}]
set_output_delay -min -clock [get_clocks {VGA_DISPLAY|vga_inst|pll_inst|vga_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -1.506 [get_ports {VGA_R[*]}]
set_output_delay -max -clock [get_clocks {VGA_DISPLAY|vga_inst|pll_inst|vga_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] 0.212 [get_ports {VGA_G[*]}]
set_output_delay -min -clock [get_clocks {VGA_DISPLAY|vga_inst|pll_inst|vga_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -1.519 [get_ports {VGA_G[*]}]
set_output_delay -max -clock [get_clocks {VGA_DISPLAY|vga_inst|pll_inst|vga_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] 0.264 [get_ports {VGA_B[*]}]
set_output_delay -min -clock [get_clocks {VGA_DISPLAY|vga_inst|pll_inst|vga_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -1.519 [get_ports {VGA_B[*]}]
set_output_delay -max -clock [get_clocks {VGA_DISPLAY|vga_inst|pll_inst|vga_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] 0.215 [get_ports VGA_BLANK_N]
set_output_delay -min -clock [get_clocks {VGA_DISPLAY|vga_inst|pll_inst|vga_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -1.485 [get_ports VGA_BLANK_N]
...
set_clock_groups -asynchronous \
    ...
    -group [get_clocks {VGA_DISPLAY|vga_inst|pll_inst|vga_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]
...
set_false_path -to [get_ports {VGA_HS VGA_VS VGA_CLK}]
set_false_path -from [get_ports {KEY[0] KEY[1] KEY[2]}] -to *
set_false_path -from [get_ports {GPIO_0[0] GPIO_0[1]}] -to *
set_false_path -from * -to [get_ports {GPIO_0[0] GPIO_0[1]}]
